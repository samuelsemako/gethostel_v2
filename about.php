...
<head>
    ...
    <title><?php echo $thename?> - About Us</title>
...
<body>
            ...
            <div class="content-div">
                <div class="home-page-div">
                    <ul>
                        ...
                        <a href="<?php echo $website_url ?>" title="About Us"><li>About us</li></a>                   
                    </ul>               
                </div>
    ...
    <section class="pages-content">
        <section class="body-div ">
            <div class="body-div-in">
                <div class="about-body-div">
                    ...
                    <div class="text-div">   
                        <h2>Our story began with a simple <span>idea</span></h2>
                        <p>We're a team of passionate individuals dedicated to providing comfortable, convenient and affordable hostel accomodations for students like you</p>
                        <p>To make student living easier, more enjoyable, and more accessible. We believe that every student deserves a safe, welcoming space to call their own without breaking bank. 
                            That's why we've curated a selection of top-notch hostels, carefully designed to meet the unique need of students.</p>                      
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="body-div values-back-div">
            <div class="body-div-in">
                <div class="about-page-cont">
                    <div class="text-div">
                        <div class="inner-text">
                            <h2>Our Values</h2>
                            <p><span>Student Centric:</span> We put your need first, always.</p>
                            <p><span>Quality Driven:</span> We handpick hostels that meet our standards.</p>
                            <p><span>Community Focus:</span> We foster connections and memories.</p>
                            <p><span>Affordability:</span> We believe student living should be within reach.</p>
                            <p><span>Innovative:</span> We continually improve and adapt to your needs.</p>
                        </div>
                    </div>

                    <div class="image-div">
                        <img src="<?php echo $website_url ?>/all-images/body-pix/house6.jpg" alt="gethostel house">
                    </div>
                </div> 
            </div>
        </section>
        ...
        <section class="body-div values-back-div">
            <div class="body-div-in">
                <div class="about-page-cont">
                    ...
                    <div class="text-div">
                        <div class="inner-text mission-inner-text">
                            <h2>Our Mission</h2>
                            <p>It is to create a supportive community that fosters acedemic success, personal growth and lasting connections</p>
                            <p>Feel free to modify it as per your requirement and branding!</p>
                            <p>Join our community today and experience the best of students</p>
                        </div>                
                    </div>
                </div>
            </div>
