...
<link href="<?php echo $website_url ?>/styles/icons-1.10.2/font/bootstrap-icons.css" type="text/css" rel="stylesheet" >
<link href="<?php echo $website_url?>/styles/animate.css" type="text/css" rel="stylesheet" media="all">
<link href="<?php echo $website_url?>/styles/aos.css" type="text/css" rel="stylesheet" />
<link href="<?php echo $website_url ?>/styles/style.css" rel="stylesheet" type="text/css"> 
<link href="<?php echo $website_url ?>/styles/paramount.css" rel="stylesheet" type="text/css"> 
